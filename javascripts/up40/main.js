...
function inject_nav() {
    ...
    nav.forEach(function(n,i){
        ...
        if (location.pathname === n.path) {
            html.push("<i class='fa fa-circle'></i>")
        } else {
            html.push("<i class='fa fa-circle-o'></i>")
        }
        html.push("</td>")
    })
    // Assemble indexes of prev/current/next page.
    var triple = [indexes[location.pathname]-1,indexes[location.pathname],indexes[location.pathname]+1]
    var p = triple[0] < 0 ? null : nav[triple[0]],
        n = triple[triple.length-1] >= indexes.length ? null : nav[triple[triple.length-1]],
        c = nav[triple[1]],
        prefix = [
            "<table style='width:100%;' class='up40-nav'>",
            "</tr>",
        ...
        postfix = [
            ...
            "</td>",
            "</tr>",
            "<tr><td style='text-align:center' colspan='" + nav.length + "'>" + (c||{}).title + "</td></tr>",
            "</table>"
        ]
        ...
        [
            {
                ...
                text: "",
                href: "/exhibits/show/warum-passau/niederbayern"
            }, {
                title: "Für Bildung",
                image: "/files/square_thumbnails/7abf49a756ede009884813af70c96f02.jpg", //veraltet
                text: "",
                href: "/exhibits/show/warum-passau/bildung"
            }
        ],[
            {
                title: "Für Passau",
                ...
                text: "",
                href: "/exhibits/show/warum-passau/passau"
            }, {
                title: "Förderer",
                image: "",
                text: "",
    ...
    '/exhibits/show/lehren-und-lernen': [
        [
        ...
        ], [
            {
                ...
                text: "",
                href: "/exhibits/show/lehren-und-lernen/abschied"
            }, {
                title: "Timeline",
